...
public class CarsServiceTest {
    ...
    public void testCarDetailsValid(){
        ...
        Optional<Car> carToBeFound = carService.getCarDetails(1L);

        assertThat(carToBeFound.get().getMaker()).isEqualTo("Porsche");

    }
    
    @Test
    public void testGetCarDetailsWrong() {
        Optional<Car> carToBeFound = carService.getCarDetails(54L);
    
        if (carToBeFound == null) {
            fail("carToBeFound is null");
        }
        
        // Adiciona esta verificação adicional
        assertThat(carToBeFound).isEmpty();
    }
